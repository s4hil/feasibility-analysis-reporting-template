...
<!-- <fieldset class="form-group">
									<label>
										<b>1.</b>
										Is the industry analysis, market trends and customer preferences supportive of your proposed business idea /product /service?
									</label>
								</fieldset>
								<fieldset class="form-group">
									<label>
										<b>2.</b>
										Do you already have a vision for digital transformation for the
										idea/product/service (that is, use of technology and capabilities) to steer your business after launching?
								...
								<fieldset class="form-group">
									<label>
										<b>3.</b>
										Do you have a business development plan for your idea/product/service?
									</label>
									<select class="form-control">
										<option value="none">Select</option>
										<option value="1">1</option>
								...
								<fieldset class="form-group">
									<label>
										<b>4.</b>
										Do you have a marketing plan for adapting to rapid changes in market trends/demands?
									</label>
									<select class="form-control">
										<option value="none">Select</option>
										<option value="1">1</option>
